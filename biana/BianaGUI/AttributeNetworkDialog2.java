 ...
 * @author  emre
 */
public class AttributeNetworkDialog2 extends javax.swing.JDialog {
    ...
    public AttributeNetworkDialog2(java.awt.Container parent, BianaDatabase bDB, HashMap<String, HashMap<String, HashMap<String, String>>> pSharingAttributesMap) {    
        super();
        this.biana_database = bDB;	
	this.sharingAttributesMap = pSharingAttributesMap;
    ...
    private void initComponents() {
        ...
        setTitle("Add Attribute Relations");
        setModal(true);
        setResizable(false);

        jLabel2.setText("1. Select attributes whose relationships to be added:");
        ...
        jLabel3.setText("2.(Optional) Adjust attribute parameters:");
...
private void jButtonAttributeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAttributeActionPerformed
    ...
    this.sharingAttributesMap.put("\""+Utilities.join(this.jListAttribute.getSelectedValues(),"\",\"")+"\"", attributeMap);
...
private void jButtonResetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonResetActionPerformed
    ...
    this.sharingAttributesMap.clear();
    while(true){
        try{
